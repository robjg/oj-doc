...
public class JavaToHtml
{
    ...
    private static final JavaToHtml instance = new JavaToHtml();

    public static String toHtml(JavaCodeBlock java) throws IOException {
        return instance.convert(java.getCode());
    }
